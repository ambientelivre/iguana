...
<title>Iguana - Business Intelligence - Login</title>
...
<table width="100%" height="100%" border="0" cellspacing="0" cellpadding="0">
  <tr height="94">
    <td bgcolor="#FFFFFF"><div id="container_header"><div id="links">
</div>
        ...
        %>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                    <td colspan="3" style="padding: 4px 20px 0 0; font-size: .8em;"><a href="http://www.pentaho.com/helpmeout/" target="_blank"><%=Messages.getString("UI.PUC.LOGIN.REQUEST_SUPPORT")%></a><img src="/pentaho-style/images/login/help_link.png" width="20" height="20" align="absbottom"></td>
                    </tr>
                  </table>
        </td>
              </tr>
        ...
        <a href="http://iguana.ambientelivre.com.br" target="_blank"><img src="/pentaho-style/images/login/logo.png" alt="Iguana" width="224" height="94" border="0" /></a></div></td>
  </tr>
  <tr height="334">
    <td class="dark"><div id="container_content"><img src="/pentaho-style/images/login/title_text.png">
        <div id="message">Solution generation data management and decision making for Systems Open Sources.</div>
      </div></td>
  </tr>
  <tr height="100%">
    <td bgcolor="#FFFFFF" valign="top"><div id="container_footer" style="padding: 4px 20px 0 80px; height:200px;"><%=Messages.getString("Iguana", String.valueOf(year))%></div></td>
  </tr>
</table>
