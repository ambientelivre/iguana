...
var OpenIAnalysis = {
	...
	initUI : function(analysisPivotID) {
		 ...
		 * Ajax.showProcessing("Loading Analysis Components");
	...
	registerAOP : function() {
		 ...
		 * function() { Ajax.showProcessing("Loading Analysis Components"); });
		 * jQuery.aop.after({ target : OlapActions, method : '[a-zA-Z]+' },
		 * function() { Ajax.hideProcessing(); });
		 */
		...
		jQuery.aop.after({
			...
			Ajax.hideProcessing("Loading Analysis Components");
		});
		jQuery.aop.after({
			target : OlapActions,
			method : 'hideEmptyRowsCols'
